...
class SendMessage(http.Controller):
    ...
    #
    #             msg += " with Total Amount " + self.format_amount(pos_order.amount_total,
    #                                                               pos_order.pricelist_id.currency_id) + "."
    ...
    #             tmp_dict = {
    #                 "phone": "+" + str(
    #                     pos_order.partner_id.country_id.phone_code) + "" + whatsapp_msg_number_without_code,
    #                 "body": msg}
